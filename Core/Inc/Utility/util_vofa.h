 ...
 * @LastEditTime: 2025-11-17 22:54:06
...
extern DMA_HandleTypeDef hdma_usart2_tx; // 假设 huart2 对应的 DMA TX 是这个
...
// 适配您的 DMA 句柄
#define VOFA_DMA_REMAIN_SIZE (__HAL_DMA_GET_COUNTER(&hdma_usart2_tx))
